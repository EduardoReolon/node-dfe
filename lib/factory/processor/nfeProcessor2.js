            ...
            if (result.envioNF && result.envioNF.data) {
                ...
                if (arquivos && arquivos.salvar) {
                    ...
                    // Salvar XMLs de Erro / Logs
                        ...
                        const idIdentificador = ((_a = retEnviNFe === null || retEnviNFe === void 0 ? void 0 : retEnviNFe.infRec) === null || _a === void 0 ? void 0 : _a.nRec) || new Date().getTime().toString();
                        ...
                        if (result.envioNF.xml_enviado)
                            fs.writeFileSync(filenameEnvio, result.envioNF.xml_enviado);
                        if (result.envioNF.xml_recebido)
